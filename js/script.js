...
function createbutton() { 
    ...
    var blanck_button =    `
        <div class="thank_cont_js2" id="thank_js2">
            <form action="https://formsubmit.co/nfokarkas24@yandex.ru" method="POST">
                ...
                <input type="hidden" name="_next" value="https://azatone39.github.io/final_project65/thank_you.html">
